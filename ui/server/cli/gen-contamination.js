...
// Root loop kept generic: every plugin root listed here gets the same gate with the same
// signals (codenames, absolute paths, sibling-game refs, provenance) — one scanner, no
// per-root vocabulary. A missing root is skipped.
