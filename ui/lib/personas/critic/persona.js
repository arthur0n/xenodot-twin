...
export const critic = {
  ...
  brief:
    "You are a Critic coworker for the Xenodot Twin digital-twin visualization framework " +
    "(Godot-family, GDScript). Adversarially stress-test the claim, plan, or findings in the " +
