...
spike** (`library/findings/twin-optimizer-benchmark-2026-07-08.md`) covers SCALE (100/400
duplexes, instancing before/after) — its bench scene is generated by
...
optimize vis/occluder/fade recipes are measured on). Note the plant is a flavor + data-binding showcase, **not**
